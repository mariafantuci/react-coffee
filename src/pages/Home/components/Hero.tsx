...
import coffee from '../../../assets/favicon.svg'

export function Hero(){
    return(
        <div className="bg-repeat bg-hero-bg py-10 lg:py-[94px] px-10 lg:px-36 flex flex-col md:grid md:grid-cols-2 gap-x-14 mb-5 lg:mb-8">
            <div className="">
                ...
                <p className="font-Roboto text-lg leading-[26px] text-base-subtitle">Com o Coffee Delivery você recebe seu café onde estiver, a qualquer hora</p>
