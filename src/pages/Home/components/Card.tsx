...
export function Card({ coffee }: coffeeProps) {
    return (
        <div className="box-border bg-base-card rounded-tl-md rounded-bl-large rounded-br-md rounded-tr-large flex justify-center flex-col w-full items-center pb-5 px-4 lg:px-5 xl:px-8 mb-10 lg:mb-12">
